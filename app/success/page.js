    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-[#f8fafc] px-6">
      <div className="bg-white rounded-3xl shadow-xl p-10 text-center max-w-lg w-full border border-slate-100">
        ...
        <div className="flex flex-col gap-4">
          <a 
            href="/orders" 
            className="w-full bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-bold py-4 px-6 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
          >
            View Order History
          </a>
          <a 
            href="/" 
            className="w-full bg-slate-100 text-slate-700 font-bold py-4 px-6 rounded-xl hover:bg-slate-200 transition-colors"
          >
            Continue Shopping
          </a>
        </div>
